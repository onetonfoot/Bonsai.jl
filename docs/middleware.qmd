...
By default `app.middleware` will run on all request methods however you can specify a specific method with `app.middleware.get` Bellow are examples of common usecases for middleware
